...
<div class="content-header">
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1 class="m-0">Data Master Inspeksi</h1>
            </div>
            <div class="col-sm-6">
                        ...
                        <table id="example1" class="table table-bordered table-striped">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <th>
                                        <a href="{{ route('dashboard.inspeksi.edit', $inspeksi->id) }}"
                                            class="text-primary">
                                            <i class="fas fa-edit"></i>
                                        </a>
                                        <a href="{{ route('dashboard.inspeksi.show', $inspeksi->id) }}"
                                            class="text-info">
                                            <i class="fas fa-eye"></i>
                                        </a>
                                        <form action="{{ route('dashboard.inspeksi.destroy', $inspeksi->id) }}"
